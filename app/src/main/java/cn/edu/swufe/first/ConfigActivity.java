...
public class ConfigActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG,"openOne:dollar2=" + dollar2);
        Log.i(TAG,"openOne:euro2=" + euro2);
        Log.i(TAG,"openOne:won2=" + won2);
    ...
    public void save(View btn){
        ...
        Log.i(TAG,"openOne:newDollar=" + newDollar);
        Log.i(TAG,"openOne:newEuroi=" + newEuroi);
        Log.i(TAG,"openOne:newWon=" + newWon);
